...
def convert_anno_to_yolo(path_to_coco_anno_file, output_folder):
    ...
    for annotation in data['annotations']:
        ...
        yolo_format = f"{category_id} {x_center} {y_center} {norm_width} {norm_height}\n"
...
def main():
    ...
    parser.add_argument('coco_anno_file_path', type=str, help='Path to the COCO annotations JSON file')
    parser.add_argument('output_folder', type=str, help='Output folder for YOLO formatted labels')
