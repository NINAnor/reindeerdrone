...
if __name__ == "__main__":
    with open("/home/taheera.ahmed/code/reindeerdrone/config.yaml") as f:
        cfg = yaml.load(f, Loader=FullLoader)

    image = "DSC00207.JPG"
    image_path = os.path.join("/home/taheera.ahmed/data/reindeerdrone/whole/train/images", image)
